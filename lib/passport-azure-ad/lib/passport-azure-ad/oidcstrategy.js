...
function Strategy(options, verify) {
  ...
  //
  options.authorizationURL = options.authorizationURL || 'https://login.microsoftonline.com/common/v2.0/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://login.microsoftonline.com/common/v2.0/oauth2/token';
  options.userInfoURL = options.userInfoURL || 'https://login.microsoftonline.com/common/v2.0/openid/userinfo';
  options.revocationURL = options.revocationURL || 'https://login.microsoftonline.com/common/v2.0/oauth2/logout';
